...
% Proč?
\input{CHAPTERS/05 - POUŽITÉ SOUČÁSTKY.tex}

% Realizace projektu
\input{CHAPTERS/010 - PROGRAM.tex}

% Návody na instalaci a rozjetí SolidWorks
\input{CHAPTERS/015 - OVLÁDÁNÍ PŘES MOBIL.tex}

% Modelování základních stroj.  součástí
\input{CHAPTERS/020 - FUNKČNOST LED.tex}

% Operace v sestavách
\input{CHAPTERS/025 - TEORETICKÉ VYUŽITÍ DO BUDOUCNA.tex}

% Návody z výkresové dokumentace
%\input{CHAPTERS/030 - VYKRESOVA-DOKUMENTACE.tex}
